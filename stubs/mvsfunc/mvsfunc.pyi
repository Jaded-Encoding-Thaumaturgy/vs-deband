...
def LimitFilter(flt: typing.Any, src: typing.Any, ref: typing.Optional[typing.Any] = ..., thr: typing.Optional[typing.Any] = ..., elast: typing.Optional[typing.Any] = ..., brighten_thr: typing.Optional[typing.Any] = ..., thrc: typing.Optional[typing.Any] = ..., force_expr: typing.Optional[typing.Any] = ..., planes: typing.Optional[typing.Any] = ...) -> vs.VideoNode: ...
